"""Configuration and credential loading for PDF-OCR-Converter (Fedora).
...
def setup_logging() -> None:
    """Attach a file handler so errors are visible even when launched from a
    file-manager context menu (no attached terminal).
